...
import lionstudy.fc.com.lionstudy.view.VitamioVideoView;
...
public class VitamioVideoPlayer extends Activity implements View.OnClickListener{
    ...
    private void showSwichPlayerDialog() {
        ...
        builder.setTitle("提示");
        builder.setMessage("当您播放视频有花屏，可以尝试使用系统播放器播放");
    ...
    private void startSystemPlayer() {
        ...
        Intent intent = new Intent(this,SystemVideoPalyer.class);
...
//                Toast.makeText(SystemVideoPalyer.this, "我被单击了", Toast.LENGTH_SHORT).show();
    ...
    class MyOnPreparedListener implements MediaPlayer.OnPreparedListener {
        ...
        public void onPrepared(MediaPlayer mp) {
            ...
            int duration = (int) videoView.getDuration();//视频的总时长
    ...
    class MyOnCompletionListener implements MediaPlayer.OnCompletionListener{
        ...
        public void onCompletion(MediaPlayer mp) {
            playNextVideo();
            Toast.makeText(VitamioVideoPlayer.this,"播放完成"+uri,Toast.LENGTH_SHORT).show();
        }
    }
